...
const EXPLORE_SCENES = [
  ...
  // ---- Cafés ----
  { id:'azimut',        cat:'Cafe', name:'Café Azimut', noBook:true,        meta:'Marina · Paseo del Mar',          desc:'The corner café at the start of the Paseo del Mar — Nespresso coffee, juices and snacks with Marina-deck views (8am–8pm).', img:'https://i0.wp.com/casadecampoliving.com/wp-content/uploads/2012/07/Azimut-Cafe1.jpg?w=1000&ssl=1' },
  { id:'voala',         cat:'Cafe', name:'Voalá Café Marché', noBook:true,   meta:'Altos de Chavón · Calle Las Piedras', desc:'A cosy brunch-and-coffee spot, gourmet deli and wine shop on the cobbled lanes of Altos de Chavón — pet-friendly.', img:'https://i0.wp.com/casadecampoliving.com/wp-content/uploads/2023/08/EJ4B4995.jpg?w=1000&ssl=1' },
  // ---- Golf ----
