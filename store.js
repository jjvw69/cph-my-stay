...
const EXPLORE_SCENES = [
  ...
  { id:'alegria',       cat:'Dining', name:'Alegría',                     meta:'Altos de Chavón',   desc:'Mediterranean cooking with a Dominican soul on the Callejón de la Alegría — Chavón River views, Chef Javier Cabrera.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2024/12/altos-de-chavon-web.jpg' },
  { id:'dolce-italia',  cat:'Dining', name:'Dolce Italia',                meta:'Marina',            desc:'Authentic Italian in the Marina — wood-fired pizza, artisanal pastries and the only Marina breakfast (from 7:45am).', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/05/A745160.jpg' },
  // ---- Cafés ----
  { id:'azimut',        cat:'Cafe', name:'Café Azimut',                   meta:'Marina · Paseo del Mar',          desc:'The corner café at the start of the Paseo del Mar — Nespresso coffee, juices and snacks with Marina-deck views (8am–8pm).', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/05/A745160.jpg' },
  { id:'voala',         cat:'Cafe', name:'Voalá Café Marché',             meta:'Altos de Chavón · Calle Las Piedras', desc:'A cosy brunch-and-coffee spot, gourmet deli and wine shop on the cobbled lanes of Altos de Chavón — pet-friendly.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2024/12/altos-de-chavon-web.jpg' },
  // ---- Golf ----
