...
function summaryStay(s) {
  ...
  return { id: s.id, reference: s.reference, status: s.status, guest: s.leadName || s.lastName || '(no name)',
    ...
    bookingAgent: s.bookingAgent || '', golfCart: golfCartDisplay(s), rowColor: s.rowColor || '' };
}
