...
const EXPLORE_SCENES = [
  ...
  { id:'minitas-club',  cat:'Dining', name:'Minitas Beach Club',          meta:'Beachfront',        desc:'Mediterranean, seafood, pizza and pasta on the sand — sea-view lunches and sunset dinners.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/Minitas_-Restaurant-3-min-800x600-1.webp', menu:'https://www.casadecampo.com.do/dining/restaurants/minitas-beach-club-restaurant/#menus' },
  { id:'la-casita',     cat:'Dining', name:'La Casita',                   meta:'Marina',            desc:'Spanish & Mediterranean seafood on an elevated Marina terrace — a sunset-reservation favourite.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/La-Casita7-800x600-1.webp', menu:'https://www.casadecampo.com.do/dining/restaurants/la-casita/#menus' },
  { id:'causa',         cat:'Dining', name:'Causa',                       meta:'Marina',            desc:'Peruvian — Creole, Nikkei and Chifa — with exceptional ceviche and tiradito.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/Causa-Restaurant.webp', menu:'https://www.casadecampo.com.do/dining/restaurants/causa/#menus' },
  { id:'sbg',           cat:'Dining', name:'SBG · Blue Grill',            meta:'Marina',            desc:'Mediterranean-international fusion — grilled fish, steaks, DJ nights and Sunday brunch.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2024/12/SBG_Marina_084-800x600-1.jpg', menu:'https://www.casadecampo.com.do/dining/restaurants/sbg/#menus' },
  { id:'la-piazzetta',  cat:'Dining', name:'La Piazzetta',                meta:'Altos de Chavón',   desc:'Fine Italian in the clifftop village — housemade pasta and a serious wine list, candlelit.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2024/12/la-piazzetta-casa-de-campo-min-1-800x600-1.jpg', menu:'https://www.casadecampo.com.do/dining/restaurants/la-piazzetta/#menus' },
  ...
  { id:'la-cana',       cat:'Dining', name:'La Caña by Il Circo',         meta:'Resort centre',     desc:"French-Mediterranean fine dining — the resort's social hub, with rum, cigars and live music.", img:'https://www.casadecampo.com.do/wp-content/smush-webp/2025/07/La-Cana-1024x514.jpg.webp', menu:'https://www.casadecampo.com.do/dining/restaurants/la-cana/#menus' },
  ...
  { id:'lago',          cat:'Dining', name:'Lago',                        meta:'Teeth of the Dog',  desc:'Buffet breakfast and à la carte overlooking the 18th fairway, by the pro shop.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/Lago-Restaurant-3-min-800x600-1.webp', menu:'https://www.casadecampo.com.do/dining/restaurants/lago/#menus' },
  // ---- Golf ----
