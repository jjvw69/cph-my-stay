...
const EXPLORE_SCENES = [
  ...
  // ---- Golf ----
  { id:'teeth-of-the-dog', cat:'Golf', name:'Teeth of the Dog',          meta:'Pete Dye · 18 holes', desc:"Pete Dye's #1-ranked Caribbean course — seven oceanfront holes 'created by God.'", img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/Casa_de_Campo_Dominica_Republic45.webp', more:'https://www.casadecampo.com.do/golf/teeth-of-the-dog/' },
  { id:'dye-fore',      cat:'Golf', name:'Dye Fore',                      meta:'Pete Dye · 27 holes', desc:'A clifftop 27 holes above the Chavón River — three nines up to 7,667 yards.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/Casa_de_Campo_Dominica_Republic19-small.webp', more:'https://www.casadecampo.com.do/golf/dye-fore/' },
  { id:'the-links',     cat:'Golf', name:'The Links',                     meta:'Pete Dye · 18 holes', desc:"Pete Dye's inland Scottish-style links — strategic, playable, built for repeat rounds.", img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/02/hole16_2.jpg.jpeg', more:'https://www.casadecampo.com.do/golf/the-links/' },
  // ---- Amenities (informational) ----
  { id:'marina',        cat:'Amenities', name:'Casa de Campo Marina',    meta:'Waterfront village',  desc:'A Mediterranean-style yacht harbour — a walkable waterfront of dining, boutiques and nightlife.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/05/A745160.jpg', info:true },
  { id:'altos',         cat:'Amenities', name:'Altos de Chavón',         meta:'Cultural village',    desc:'A re-created 16th-century Mediterranean clifftop village — amphitheatre, museum, galleries and dining.', img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2024/12/altos-de-chavon-web.jpg', info:true },
  { id:'minitas-beach', cat:'Amenities', name:'Minitas Beach',           meta:'Private · on resort', desc:"Casa de Campo's only private beach — calm, swimmable Caribbean water and full beach-club facilities.", img:'https://caribbeanparadisehomes.com/wp-content/uploads/sites/58/2026/06/Casa_de_Campo_Dominica_Republic34.webp', info:true },
  ...
  { id:'kayak', cat:'Activities', name:'Chavón River Kayak', meta:'Chavón River', desc:'Paddle the tranquil Chavón River past lush tropical vegetation — single or double kayaks.', img:'https://www.casadecampo.com.do/wp-content/smush-webp/2025/09/Lake_17877-1024x767.jpg.webp', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  { id:'funcat', cat:'Activities', name:'Fun Cat Caribe', meta:'Chavón River · 1.5h', desc:'Drive your own two-person motorized catamaran on a guided tour of the beautiful Chavón River.', img:'https://www.casadecampo.com.do/wp-content/uploads/2019/07/excursions.jpg', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  ...
  { id:'zipline', cat:'Activities', name:'Cumayasa Zip Line', meta:'Adventure', desc:'Fly over the lush flora of the eastern region with certified guides on this thrilling zip-line course.', img:'https://www.casadecampo.com.do/wp-content/uploads/2025/09/765bd25d395135d72f32c809f469aa6f125fac64.jpg', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  { id:'buggies', cat:'Activities', name:'Cumayasa Buggies', meta:'Off-road · ages 5+', desc:'Take the wheel and race through the Dominican countryside in your own off-road buggy.', img:'https://www.casadecampo.com.do/wp-content/uploads/2025/09/Buggies.jpg', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  { id:'marinarium', cat:'Activities', name:'Marinarium', meta:'Bávaro · marine park', desc:'A catamaran cruise to a unique marine park — snorkel with rays and nurse sharks in a natural pool.', img:'https://www.casadecampo.com.do/wp-content/uploads/2025/09/765bd25d395135d72f32c809f469aa6f125fac64.jpg', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  ...
  { id:'cave', cat:'Activities', name:'Las Maravillas Cave', meta:'La Romana · half day', desc:'Explore a 100,000-year-old cave of Taíno rock art — the first natural museum of its kind in the West Indies.', img:'https://www.casadecampo.com.do/wp-content/uploads/2025/09/Maravillas-Cave.jpg', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  { id:'santo-domingo', cat:'Activities', name:'Santo Domingo City Tour', meta:'Capital · full day', desc:'Discover the oldest city in the New World — museums, cathedrals and historic landmarks of the capital.', img:'https://www.casadecampo.com.do/wp-content/uploads/2025/09/765bd25d395135d72f32c809f469aa6f125fac64.jpg', more:'https://www.casadecampo.com.do/experiences/excursions/' },
  { id:'cigar', cat:'Activities', name:'Cigar Factory Tour', meta:'Tabacalera de García', desc:"Tour the world's largest hand-rolled cigar factory — home of Montecristo, Romeo y Julieta and more.", img:'https://www.casadecampo.com.do/wp-content/smush-webp/2025/09/manos-1024x949.jpg.webp', more:'https://www.casadecampo.com.do/experiences/excursions/' },
