...
const EXPLORE_SCENES = [
  ...
  // ---- Cafés ----
  { id:'azimut',        cat:'Cafe', name:'Café Azimut', noBook:true,        meta:'Marina · Paseo del Mar',          desc:'The corner café at the start of the Paseo del Mar — Nespresso coffee, juices and snacks with Marina-deck views (8am–8pm).', img:'https://i0.wp.com/casadecampoliving.com/wp-content/uploads/2012/07/azimut_cafe1.jpg?w=1000&ssl=1' },
